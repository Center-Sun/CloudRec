        ...
        try {
            switch (platform) {
                ...
                case PlatformType.Enum.KINGSOFT_CLOUD:
                    ...
                    break;
                case PlatformType.Enum.VOLCENGINE:
                    VolcengineCredential volcengineCredential = new Gson().fromJson(credentialsJson, VolcengineCredential.class);
                    map.put("ak", volcengineCredential.getAk());
                    map.put("sk", volcengineCredential.getSk());
                    break;
                case PlatformType.Enum.UCLOUD:
                    UCloudCredential uCloudCredential = new Gson().fromJson(credentialsJson, UCloudCredential.class);
                    map.put("ak", uCloudCredential.getAk());
                    map.put("sk", uCloudCredential.getSk());
                    break;
                case PlatformType.Enum.CODO:
